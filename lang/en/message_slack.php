...
/**
 * Strings for slack message plugin.
 *
...
$string['configslackbuttonurl'] = 'Slack button URL fron your Slack Button page (https://api.slack.com/docs/slack-button)';
...
$string['slackbuttonurl'] = 'Slack button URL';
